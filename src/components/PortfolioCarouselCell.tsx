...
/** Toque rápido (< este valor) troca de foto; pressionar mantém ampliado. */
const TAP_MS = 380;
  ...
  return (
    <>
      <button
        ...
        aria-label={
          n > 1
            ? `${photo.style}: toque rápido para próxima foto, pressione para ampliar (${active + 1} de ${n})`
            : `${photo.style}: pressione para ampliar`
        }
      >
        <img
          src={current.image}
