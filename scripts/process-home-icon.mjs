...
const SRC = path.join(
  ...
  "assets",
  "c__Users_victo_AppData_Roaming_Cursor_User_workspaceStorage_empty-window_images_Captura_de_tela_2026-05-22_004427-c04da42c-ab78-43b1-a7e6-5fde3f654031.png",
);

const OUT = path.join(root, "public", "home-icon.png");
...
async function main() {
  ...
  for (let y = 0; y < height; y++) {
    for (let x = 0; x < width; x++) {
      ...
      const alpha = Math.min(255, Math.round(ink * 1.15));
      out[o] = 255;
      out[o + 1] = 255;
      out[o + 2] = 255;
      out[o + 3] = alpha;
